  ...
  return (
    ...
    <div className="col-xxl-2 col-xl-3 col-lg-3  admin-sidebar fixed-top">
        ...
        <ul className="navbar-nav flex-column mt-2">
            <li className="nav-item"><a href="#" className="nav-link text-white bg-secondary p-3 mb-2 admin-sidebar__panel" onClick={() => {startShowing('Dashboard')}}>
                <i className="fa-solid fa-house-user text-light fa-lg me-3"></i>Dashboard</a>
            </li>
            <li className="nav-item"><a href="#" className="nav-link text-white p-3 mb-2 admin-sidebar__link" onClick={() => {startShowing('Bookings')}}>
                <i className="fa-solid fa-list text-light fa-lg me-3"></i>Bookings</a>
            </li>
            <li className="nav-item"><a href="#" className="nav-link text-white p-3 mb-2 admin-sidebar__link" onClick={() => {startShowing('Agents')}}>
                <i className="fa-solid fa-user-tie text-light fa-lg me-3"></i>Agents</a>
            </li>
            <li className="nav-item"><a href="#" className="nav-link text-white p-3 mb-2 admin-sidebar__link" onClick={() => {startShowing('Package')}}>
                <i className="fa-solid fa-box text-light fa-lg me-3"></i>Package</a>
            </li>
        </ul>
    </div>
    {
