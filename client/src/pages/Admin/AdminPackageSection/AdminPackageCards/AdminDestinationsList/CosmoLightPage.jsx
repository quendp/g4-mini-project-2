...
import { cosmopolitanLights } from "../../../AdminDataCollection/AdminPackageSectionData";

const CosmoLightPage = (props) => {
  const [selectedPackages, setSelectedPackages] = useState(
    cosmopolitanLights.reduce(
  ...
  const handlePackageSelect = (id, packageType) => {
    setSelectedPackages((prevState) => ({ ...prevState, [id]: packageType }));
  };
  ...
  return (
    <>
      ...
      >
        ...
        >
          Cosmopolitan Lights Destinations
        </h4>
        {cosmopolitanLights.map((info) => (
