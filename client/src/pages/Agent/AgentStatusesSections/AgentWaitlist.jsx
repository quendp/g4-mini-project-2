...
import AgentWailtlistModal from "./AgentStatusesModal/AgentWailtlistModal";
                ...
                <div className="card agentStatuses-cards">
                  ...
                  <div className="card-footer text-secondary d-flex alight-items-center justify-content-between">
                    {travelDetail.status === "Waitlist" ? (
                      <button
                        type="button"
                        className="agentWaitlist-cards__btn btn-outline-info"
                        onClick={() =>
                          getData(
                            travelDetail.transportationCost,
                            travelDetail.accommodationCost,
                            travelDetail.otherCost,
                            travelDetail.totalCost
                          )
                        }
                      >
                        Proceed
