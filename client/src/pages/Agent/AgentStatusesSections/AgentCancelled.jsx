...
import AgentCancelledModal from "./AgentStatusesModal/AgentCancelledModal";
                ...
                <div className="card agentStatuses-cards">
                  ...
                  <div className="card-footer text-secondary d-flex alight-items-center justify-content-between">
                    {travelDetail.status === "Cancelled" ? (
                      <button
                        type="button"
                        className="agentCancelled-cards__btn btn-outline-info"
                        onClick={() =>
                          getDataRemove(
                            travelDetail.fullName,
                            travelDetail.cancelledReason
                          )
                        }
                      >
                        Remove
