    ...
    <div className="modal show-fade" style={modelStyle}>
        <div className="modal-dialog">
            ...
            <div className="modal-header">
                <h4 className="modal-title">New Booking!</h4>
                <button type="button" className="btn-close btn-close" data-bs-dismiss="modal" aria-label="Close" onClick={props.hide}></button>
            </div>
