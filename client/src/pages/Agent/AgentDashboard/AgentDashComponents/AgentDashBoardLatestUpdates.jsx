...
const AgentDashBoardLatestUpdates = (props) => {
  ...
  return (
    ...
    <div className= {(props.status === 'Waitlist')? 'card agentDashBoardLatestUpdates-cards my-1 text-bg-primary':
                     (props.status === 'Tentative')? 'card agentDashBoardLatestUpdates-cards cards my-1 text-bg-secondary':
                     (props.status === 'Confirmed')? 'card agentDashBoardLatestUpdates-cards my-1 text-bg-success': 
