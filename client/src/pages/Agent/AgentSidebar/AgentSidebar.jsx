...
const AgentSidebar = (props) => {
  ...
  return (
    <>
          ...
          <ul className="navbar-nav flex-column mt-2">
            ...
            >
              <a
                href="#"
                to=""
                className="nav-link text-white p-3 mb-2 bg-secondary agentSidebar-dashboard__navItem"
              >
                <i className="fa-solid fa-chart-line text-light fa-lg me-3"></i>
                Dashboard
              </a>
            </li>
            {
              <>
                ...
                >
                  ...
                  >
                    <i className="fa-solid fa-list text-light fa-lg me-3"></i>
                    Waitlist
                  </a>
                </li>
                <li
                ...
                >
                  <a
                    ...
                    className="nav-link text-white p-3 mb-2 agentSidebar-navItem"
                  >
                    <i className="fa-solid fa-question text-light fa-lg me-3"></i>
                    Tentative
                  </a>
                </li>
                <li
                ...
                >
                  <a
                    ...
                    className="nav-link text-white p-3 mb-2 agentSidebar-navItem"
                  >
                    <i className="fa-solid fa-check text-light fa-lg me-3"></i>
                    Confirmed
                  </a>
                </li>
                <li
                ...
                >
                  <a
                    ...
                    className="nav-link text-white p-3 mb-2 agentSidebar-navItem"
                  >
                    <i className="fa-solid fa-ban text-light fa-lg me-3"></i>
                    Cancelled
                  </a>
                </li>
              </>
      ...
      {isShowing && currentNavSection == "Dashboard" && (
        <AgentDashboard
      ...
      {isShowing && currentNavSection == "Waitlist" && (
        <AgentSidebarWaitlistNav
          travelDetails={props.travelDetails}
      ...
      {isShowing && currentNavSection == "Tentative" && (
        <AgentSidebarTentativeNav travelDetails={props.travelDetails} />
      )}
      {isShowing && currentNavSection == "Confirmed" && (
      ...
      {isShowing && currentNavSection == "Cancelled" && (
