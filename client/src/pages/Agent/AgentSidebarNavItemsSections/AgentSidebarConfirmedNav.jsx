...
import AgentConfirmedModal from './AgentSideBarItemsModal/AgentConfirmedModal'
import './AgentSidebarConfirmedNav.css'
...
const AgentSidebarConfirmedNav = (props) => {
  ...
  return (
    <section id='bookingsSection' style={{height: '100vh'}}>
              ...
              <div className="row pt-lg-2 mb-5 mx-2">
                {
                        ...
                        <div className="col-xxl-3 col-xl-3 col-lg-6 col-md-6 p-2" key={index}>
                            ...
                            <div className="card-body">
                                ...
                                {(travelDetail.status === 'Confirmed')?<button type='button' className='agentSidebarConfirmedNav-cards__btn btn-outline-info' 
			                    onClick={() => getDataSubmit(travelDetail.destination, travelDetail.package, travelDetail.fullName)}>View</button>:''}

                                <span className='agentSidebarConfirmedNav-cards__span'>{travelDetail.status}</span>
                                </div>
                            </div>
                        </div>
                        ))
      ...
      {
        modelSubmit === true ? <AgentConfirmedModal
